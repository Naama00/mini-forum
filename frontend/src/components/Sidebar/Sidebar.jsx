      ...
      <aside className={`relative sidebar-shell ${isCollapsed ? 'collapsed' : ''}`} dir="rtl">
        ...
        {!isCollapsed && (
          <button
            ...
            className="absolute top-6 left-4 z-50 p-2 rounded-2xl border border-white/10 bg-dark-900/70 text-dark-300 hover:border-neon-lime/40 hover:text-neon-lime transition-all"
          >
